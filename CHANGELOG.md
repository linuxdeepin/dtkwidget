...
- Delegate split menu to window manager
- Constrain breadcrumb text width and elide overflow
...
- Move Qt::Svg from public to private dependency
- Reject on close to avoid accepted()
- Update dialog size after resize event with fractional scaling
- Update bloom checkbox and radio icons
- Correct option button hover state after popup menu closes

## [6.7.47] - 2026-07-28

### Added

- Add null check for QDrag after exec in DTabBarPrivate::startDrag

### Changed

- I18n: Translate dtkwidget.ts in pt_BR (#759)

### Fixed

- Fix(CI): broken cppcheck
- Fix: restore soft keyboard input support in Qt6 for DLineEdit and
- Make dtkwidget buildable on Windows/MSYS2

## [6.7.46] - 2026-07-16

### Added

- Add source root to include paths
